  ...
  const infoSections = [
    ...
    },
    {
      ...
      contentParagraphs: [
        ...
        "Ngoài tên thường gọi HoiQuanTV, fan hâm mộ còn biết đến chúng tôi với các tên khác như Xoilac 1, 2, 7, Xoilac8, Live, Net, Link… vì sự yêu mến của quý bạn có thể gọi chúng tôi bất kì tên nào mà mình dễ nhớ.",
