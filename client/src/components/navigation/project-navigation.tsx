...
const ProjectNavigation = ({
  ...
  return (
    <motion.nav
      ...
      className={`h-full flex flex-col gap-8 w-64 absolute bg-slate-300/20 shadow-sm ml-0 ${
    ...
    >
      ...
      <div className="flex flex-col gap-3">
        <NavigationLink name="Progress">
          <ArrowTrendingUpIcon className="stroke-1 stroke-gray-800/70 min-w-8 w-8" />
        </NavigationLink>
        <NavigationLink name="Team Members">
          <UserGroupIcon className="stroke-1 stroke-gray-800/70 min-w-8 w-8" />
        </NavigationLink>
        <NavigationLink name="In Review">
          <PencilIcon className="stroke-1 stroke-gray-800/70 min-w-8 w-8" />
        </NavigationLink>
        <NavigationLink name="In Progress">
          <BoltIcon className="stroke-1 stroke-gray-800/70 min-w-8 w-8" />
        </NavigationLink>
        <NavigationLink name="Up Next">
          <CursorArrowRaysIcon className="stroke-1 stroke-gray-800/70 min-w-8 w-8" />
        </NavigationLink>
        <NavigationLink name="Project Settings">
          <AdjustmentsHorizontalIcon className="stroke-1 stroke-gray-800/70 min-w-8 w-8" />
        </NavigationLink>
      </div>
